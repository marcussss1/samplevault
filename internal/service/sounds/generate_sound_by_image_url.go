...
func (s Service) GenerateSoundByImageURL(ctx context.Context, imageURL, userID string) (model.Sound, error) {
	// todo вынести в общую
	_, err := s.mlClient.GenerateSoundByImageURL(ctx, imageURL)
	if err != nil {
